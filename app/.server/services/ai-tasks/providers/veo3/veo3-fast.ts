...
const config: ProviderConfig<"google/veo3-fast", Veo3ImageToVideoOptions> = {
  type: "google/veo3-fast",
  ...
  calculateCredits(values) {
    ...
    if (aspectRatio === "16:9") secondCredits = 20;
    else if (aspectRatio === "9:16") secondCredits = 30;
...
/**
 * Google Veo3 Fast Provider 实现
 * 用于处理 Google Veo3 Fast AI 服务的图像转视频任务（快速版本）
 */
export const veo3FastProvider = new BaseProvider(config);
