import type { FotoProfissionalActionData } from "~/routes/_api/basic/_ai.generate.ghost-face/route";
 ...
 */
export async function submitGhostFace({
  image,
  ...rest
  ...
  const response = await fetch("/api/generate/ghost-face", {
    method: "POST",
    body: form,
  });
