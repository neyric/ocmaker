...
分享一个背景片段。
她曾偷运一枚加密记忆碎片，让失散的双胞胎科学家重聚，并阻止了一场失控的 AI 级联。`,
  },
  {
    title: "都市合成师",
...
分享一个背景片段。
在朋友被困于停电事件后，她打造了一间可携式录音室，同时还能充当救援信标。`,
  },
  {
    title: "奥术档案官",
